...
namespace PHPSTORM_META {
    ...
    expectedReturnValues(\Psr\Http\Message\ResponseInterface::getStatusCode(),
        // 1xx
    ...
    expectedArguments(\Psr\Http\Message\ResponseInterface::withStatus(),
        0,
        // 1xx
        \Yiisoft\Http\Status::CONTINUE,
        \Yiisoft\Http\Status::SWITCHING_PROTOCOLS,
    ...
    expectedArguments(\Psr\Http\Message\ResponseFactoryInterface::createResponse(),
        0,
        // 1xx
        \Yiisoft\Http\Status::CONTINUE,
        \Yiisoft\Http\Status::SWITCHING_PROTOCOLS,
